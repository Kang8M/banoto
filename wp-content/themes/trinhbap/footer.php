...
<?php if(wp_is_mobile()) { ?>
    <section class="call_btns_wrapper" style="height: 67px;">
        <div class="call_btns fixed_bot">
            <div class="row">
                <div class="col s4">
                    <a href="#baogia" class="modal-trigger k_btn t_black">Báo giá</a>
                </div>
                <div class="col s4">
                    <a class="call4mobi k_btn t_call waves-effect waves-light" data-phone="<?php echo get_option('contact_hotline'); ?>" href="tel:<?php echo get_option('contact_hotline'); ?>" onclick="PhoneTracking('<?php echo get_option("contact_hotline"); ?>') ">
                        Gọi ngay
                    </a>
                </div>
            </div>
    ...
    <div id="baogia" class="modal modal-fixed-footer modal-style modal-quotation-v1 modal-v1">
        <div class="modal-content">
            <button class="modal-close">×</button>
            <h4>Yêu cầu báo giá</h4>
            <p>
                Chào anh chị,
                Để nhận được "báo giá đặc biệt" từ <?php echo get_option('contact_fullname'); ?>,
                các anh chị hãy liên hệ với <?php echo get_option('contact_fullname'); ?>
                qua số:
                <a class="smartobj">
                    <span class="phone">
                        <?php echo get_option('contact_hotline'); ?>
                    </span>
                </a> hoặc điền form báo giá dưới đây.Cảm ơn!
            </p>
            <form method="post" role="form" id="frm-contact-v2" class="form-yeu-cau-bao-gia">
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <label for="pop_car" style="position: initial; font-size: 12px; margin-bottom: -10px;">Chọn dòng xe</label>
                        <div class="select-wrapper">
                            <select class="select-product" id="pop_car" style="display: block; border: 1px solid #9e9e9e; margin-bottom: 10px; margin-top: 5px; width: 100%;">
                    ...
                    <div class="input-field col s12">
                        <div class="radio-group" style="margin-left: 0px; margin-bottom: 10px;">
                    ...
                    <div class="input-field col s12">
                        <div class="select-wrapper">
                            <label for="pop_car" style="position: initial; font-size: 12px; margin-bottom: -10px;">Chọn khu vực</label>
                            <select id="drive_address" name="khu_vuc" class="input-khuvuc" style="display: block; border: 1px solid #9e9e9e; margin-bottom: 10px; margin-top: 5px; width: 100%;">
    ...
    <script type="text/javascript">
        $('#baogia #Phone').keydown(function (event) {
        ...
        function SendContact() {
            var payment = "";
            if($('#baogia #pop_payany').is(':checked')) {
                payment = "Trả góp";
            }
            if($('#baogia #pop_payall').is(':checked')) {
                payment = "Trả hết";
            }
            $("#baogia #Description").val("Cần báo giá xe : " + $("#baogia #pop_car").val() + ". Hình thức: " + payment + ". Tỉnh thành: " + $("#modal-quotation-v2 #drive_address").val());
    ...
    <!-- Popup Tra gop -->
    <div id="tragop" class="modal modal-fixed-footer modal-style modal-bank-v2 modal-v2">
        <div class="modal-content">
            <button class="modal-close">×</button>
            <h4>Ước tính trả góp</h4>
            <p>
                Chào anh chị,
                Để nhận được "MỨC TRẢ GÓP TỐT NHẤT VÀ LÃI SUẤT THẤP" khi mua xe, hãy liên hệ Ngay <?php echo get_option('contact_fullname'); ?>
                qua số:
                <a class="smartobj">
                    <span class="phone">
                        <?php echo get_option('contact_hotline'); ?>
    ...
    <input type="hidden" id="contact-name" value="<?php echo get_option('contact_fullname'); ?>"/>
    <script type="text/javascript">
        $('#tragop #Phone').keydown(function (event) {
            // Allow special chars + arrows
            if (event.keyCode == 46 || event.keyCode == 8 || event.keyCode == 9
                || event.keyCode == 27 || event.keyCode == 13
                || (event.keyCode == 65 && event.ctrlKey === true)
        ...
        function SendContactBank() {
            var payment = "";
            if ($('#tragop #pop_payany').is(':checked')) {
                payment = "Trả góp";
            }
            if ($('#tragop #pop_payall').is(':checked')) {
                payment = "Trả hết";
            }
            $("#tragop #Description").val("Cần báo giá ước tính trả góp : " + $("#tragop #pop_car").val() + ". Hình thức: " + payment + ". Tỉnh thành: " + $("#tragop #drive_address").val());
    ...
    <!-- Popup Lai thu -->
    <div id="laithu" class="modal modal-fixed-footer modal-style modal-test-drive-v2 modal-v2">
        <div class="modal-content">
            <button class="modal-close">×</button>
            <h4>Đăng ký lái thử</h4>
            <p>
                Chào anh chị,
                Để trãi nghiệm xe Chevrolet MIỄN PHÍ từ <?php echo get_option('contact_fullname'); ?>
    ...
    <input type="hidden" id="contact-name" value="<?php echo get_option('contact_fullname'); ?>"/>
    <script type="text/javascript">
        $('#laithu #Phone').keydown(function (event) {
            // Allow special chars + arrows
            if (event.keyCode == 46 || event.keyCode == 8 || event.keyCode == 9
                || event.keyCode == 27 || event.keyCode == 13
                || (event.keyCode == 65 && event.ctrlKey === true)
        ...
        function SendContactDriver2() {
            $("#laithu #Description").val("Cần lái thử xe : " + $("#laithu #pop_car").val() + ". Tỉnh thành: " + $("#laithu #drive_address").val());
    ...
    <!--  Scripts-->
<!--    <script src="--><?php //echo get_template_directory_uri(); ?><!--/mobile/js/jquery-2.1.4.js"></script>-->
    <script src="<?php echo get_template_directory_uri(); ?>/mobile/js/materialize.js"></script>
<!--    <script src="--><?php //echo get_template_directory_uri(); ?><!--/mobile/js/js.cookie.js"></script>-->
<!--    <script src="--><?php //echo get_template_directory_uri(); ?><!--/mobile/js/randtracker.js"></script>-->
<!--    <link href="--><?php //echo get_template_directory_uri(); ?><!--/mobile/js/select2.css" rel="stylesheet" />-->
<!--    <script src="--><?php //echo get_template_directory_uri(); ?><!--/mobile/js/select2.js"></script>-->
    <script src="<?php echo get_template_directory_uri(); ?>/mobile/js/app.js"></script>
<!--    <script src="--><?php //echo get_template_directory_uri(); ?><!--/js/jquery.validate.min.js"></script>-->
<!--    <script src="--><?php //echo get_template_directory_uri(); ?><!--/js/jquery.validate.unobtrusive.min.js"></script>-->
<!--    <script src="--><?php //echo get_template_directory_uri(); ?><!--/mobile/js/send-contact.js"></script>-->
