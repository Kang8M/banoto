...
define('MENU_TITLE', 'Cấu Hình Web');
...
if (!class_exists('acera_theme_options')) {
    class acera_theme_options
    {
        ...
        {
            add_menu_page(__(MENU_TITLE), __(MENU_TITLE), 'administrator', '' . MENU_SLUG, array(&$this, 'acera_display_page'), get_stylesheet_directory_uri() . "/includes/framework/" . 'images/logo2.png');
        }
        ...
        { ?>
            ...
            <style type="text/css">
                #acera-main-menu > li:last-child {
                    display: none;
                }
                #general_about, #contact_about {
                ...
                #promotion-config .label {
                    font-weight: bold;
                }

                #promotion-config .label, #promotion-config .settings-content, #promotion-config textarea{
                    width: 100% !important;
            ...
            <script type="text/javascript"
                    src="<?php echo get_stylesheet_directory_uri() . "/includes/framework/"; ?>js/colorpicker.js"></script>
            <script type="text/javascript"
                    src="<?php echo get_stylesheet_directory_uri() . "/includes/framework/"; ?>js/ajaxupload.js"></script>
            <script type="text/javascript"
                    src="<?php echo get_stylesheet_directory_uri() . "/includes/framework/"; ?>js/mainJs.js"></script>
            <form id="acera-settings" method="post">
                <?php if ($_POST["action"]) { ?>
                    <div id="message" class="datexpost updated notice notice-success is-dismissible below-h2">
                    ...
                    <ul id="acera-main-menu">
                                        ...
                                        <?php foreach ($this->options as $sections):
                                            if (($sections['section'] == $section) && (($sections['type'] == "heading") || ($sections['type'] == "html"))): ?>
                                                <li><a<?php if ($first) {
                                                        ...
                                                        $first = false;
                                                    } ?> href="#" rel="<?php echo $sections['id']; ?>">
                                                        <p><?php echo $sections['title']; ?></p></a></li>
                        ...
                        <li><p>Mundothemes</p>
                            <ul class="default-accordion">
                                <li><a href="#" rel="ChangeLog"><p><?php _e('Change Log', 'mundothemes'); ?></p></a>
                                </li>
                                <li><a href="#" rel="contacto"><p><?php _e('Request Support', 'mundothemes'); ?></p></a>
                                </li>
                                <li><a href="https://mundothemes.com/forums/foro/5/grifus/" target="_blank"
                                       rel="contacto"><p><?php _e('Forums', 'mundothemes'); ?></p></a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                        ...
                        <?php if ($option['type'] == "heading"): ?>
                            ...
                            <div class="tab-content" id="<?php echo $option['id']; ?>">
                                <div class="acera-settings-headline">
                                    ...
                                    <a href="https://mundothemes.com/?key=<?php echo get_option('edd_sample_theme_license_key'); ?>&ref=framework"
                                       target="_blank"><img class="mundothemes" style="height: 60px;" src="<?php echo get_stylesheet_directory_uri() . "/includes/framework/"; ?>images/logo.png"></a>
                                </div>
                                <?php
                                ...
                                if ($key = get_option('edd_sample_theme_license_key')) { ?>
                                    <span class="key_mt">
&copy; <b><a href="https://mundothemes.com/grifus/?key=<?php echo $key; ?>"
             target="_blank"><?php echo THEME_NAME; ?></a></b> <?php echo THEME_VERSION; ?> - <b><?php echo $key; ?></b></span>
                                <?php } ?>
                                <input name="save" class="save-button" type="submit"
                                       value="<?php _e('Save Changes', 'mundothemes'); ?>"/>
                            </div>
                        <?php endif; ?>
                    ...
                    <div class="tab-content" id="contacto" style="display:none">
                        ...
                        <iframe width="673" height="650"
                                src="//mundothemes.com/cpa/soporte/index.php?mail=<?php echo get_option("admin_email"); ?>&licencia=<?php echo get_option('edd_sample_theme_license_key'); ?>&theme=<?php echo THEME_NAME; ?>&version=<?php echo THEME_VERSION; ?>"
                    ...
                    <div class="tab-content" id="ChangeLog" style="display:none">
                        ...
                        <iframe width="673" height="650" src="//mundothemes.com/grifus/?cambios=true" frameborder="0"
        ...
        public function display_text($value)
        {
            ...
            <div<?php echo $rel; ?> class="separator2">
                ...
                <div class="settings-content">
                    ...
                    <input<?php if ($value['placeholder']) echo ' placeholder="' . $value['placeholder'] . '"'; ?>
                            class="acera-fullwidth" id="<?php echo $value['id']; ?>" name="<?php echo $value['id']; ?>"
                            type="text"
                            value="<?php if (get_option($value['id'])) echo esc_html(stripslashes(get_option($value['id']))); else echo $value['default']; ?>"/>
        ...
        public function display_color($value)
        {
            ...
            <div<?php echo $rel; ?> class="separator2">
                ...
                <div class="settings-content">
                    ...
                    <input<?php if ($value['placeholder']) echo ' placeholder="' . $value['placeholder'] . '"'; ?>
                            class="acera-color-picker"<?php echo $color; ?> id="<?php echo $value['id']; ?>"
                            name="<?php echo $value['id']; ?>" type="text"
                            value="<?php if (get_option($value['id'])) echo esc_html(stripslashes(get_option($value['id']))); else echo $value['default']; ?>"/>
                    <p class="description"><?php echo $value['desc']; ?></p>
                </div>
            </div>
        ...
        public function display_image($value)
        {
            ...
            <div<?php echo $rel; ?> class="separator2">
                ...
                <div class="settings-content">
                    ...
                    <input<?php if ($value['placeholder']) echo ' placeholder="' . $value['placeholder'] . '"'; ?>
                            class="acera-fullwidth" type="text" value="<?php echo $def_value; ?>"
                            name="<?php echo $value['id']; ?>"/>
                    <span class="upload acera_upload acera-button-blue"
                          id="<?php echo $value['id']; ?>"><?php _e('Upload Image', 'mundothemes'); ?></span>
                    <?php if (get_option($value['id'])): ?>
                        <span type="button" class="acera_remove acera-button"
                              id="remove_<?php echo $value['id']; ?>"><?php _e('Remove image', 'mundothemes'); ?></span>
                    <?php endif; ?>
                    <div class="acera_image_preview">
                        <?php if (get_option($value['id'])): ?>
        ...
        public function display_textarea($value)
        {
            ...
            <div<?php echo $rel; ?> class="separator2">
                ...
                <div class="settings-content">
                    ...
                    <textarea<?php if ($value['placeholder']) echo ' placeholder="' . $value['placeholder'] . '"'; ?>
                            id="<?php echo $value['id']; ?>" name="<?php echo $value['id']; ?>" cols="70" rows="8"><?php
                        if (get_option($value['id']))
                ...
                <div class="settings-content">
                    ...
                    foreach ($value['options'] as $box):
                        ...
                        <label for="<?php echo $value['id'][$i]; ?>">
                            <input type="checkbox"<?php echo $checked; ?> name="<?php echo $value['id'][$i]; ?>"
                ...
                <div class="settings-content">
                    <div class="cOf">
                        ...
                        foreach ($value['options'] as $box):
                            ...
                            <label class="acera-image-checkbox<?php echo $class; ?>"
                                   for="<?php echo $value['id'][$i]; ?>">
                                <img <?php echo $img_size; ?> src="<?php echo $value['image_src'][$i]; ?>"
                                                              alt="<?php echo $box ?>"/>
                                <input class="acera-image-checkbox-b" type="checkbox"<?php echo $checked; ?>
                                       name="<?php echo $value['id'][$i]; ?>" id="<?php echo $value['id'][$i]; ?>"/>
            ...
            <div<?php echo $rel; ?> class="separator2">
                ...
                <div class="settings-content">
                    ...
                    foreach ($value['options'] as $option):
                        ...
                        <label for="<?php echo $value['id'] . $i; ?>">
                            <input type="radio" id="<?php echo $value['id'] . $i; ?>" name="<?php echo $value['id']; ?>"
                                   value="<?php echo $value['options'][$i]; ?>" <?php echo $checked; ?> />
                            <?php echo $option; ?>
                        </label>
                        <?php $i++; endforeach; ?>
                    <p class="description"><?php echo $value['desc']; ?></p>
                ...
                <div class="settings-content">
                    <div class="cOf">
                        ...
                        foreach ($value['options'] as $option):
                            ...
                            <label class="acera-image-radio<?php echo $class; ?>"
                                   for="<?php echo $value['id'] . $i; ?>">
                                <img <?php echo $img_size; ?> src="<?php echo $value['image_src'][$i]; ?>"
                                                              alt="<?php echo $box ?>"/>
                                <input class="acera-image-radio-b" type="radio" id="<?php echo $value['id'] . $i; ?>"
                                       name="<?php echo $value['id']; ?>"
                                       value="<?php echo $value['options'][$i]; ?>" <?php echo $checked; ?> />
                                <?php if ($value['show_labels'] == "true"): ?>
                                    <p><?php echo $option; ?></p><?php endif; ?>
                            </label>
                            <?php $i++; endforeach; ?>
                    </div>
                    <p class="description"><?php echo $value['desc']; ?></p>
