<?php
    function dang_ky_lai_thu() {
        global $wpdb;
        $table_name = "bap_dang_ky_lai_thu";
        $where = ' 1 = 1 ';
        $limit = 20;
...
?>
    ...
    <div class="wrap">
        <h2 class="titel-friends" style="float: left; width: calc(100% -  100px);"><?php echo __('Đăng Ký: Lái Thử'); ?></h2>
        <div class="box-filter-friends" style="float: right; width: 100px; border: none; margin-top: 5px;">
            <form id="form-filter">
                <input type="hidden" name="page" value="dang_ky_lai_thu">
        ...
        <div class="box-list-friends">
            ...
            <?php 
                ...
                if($lastpage > 1){   
                    ...
                    if ($page > 1)
                        $pagination.= "<a href='admin.php?page=dang_ky_lai_thu&limit=".$limit."&page-load=".$prev."'>" . __('&laquo; Previous&nbsp;&nbsp;') . "</a>";
                    else
                    ...
                    {   
                        for ($counter = 1; $counter <= $lastpage; $counter++)
                        {
                            if ($counter == $page)
                                ...
                                $pagination.= "<a href='admin.php?page=dang_ky_lai_thu&limit=".$limit."&page-load=".$counter."'>$counter</a>";     
                    ...
                    elseif($lastpage > 5 + ($adjacents * 2))
                    {
                        if($page < 1 + ($adjacents * 2))
                        {
                            ...
                            $pagination.= "...";
                            $pagination.= "<a href='admin.php?page=dang_ky_lai_thu&limit=".$limit."&page-load=".$lpm1."'>$lpm1</a>";
                            $pagination.= "<a href='admin.php?page=dang_ky_lai_thu&limit=".$limit."&page-load=".$lastpage."'>$lastpage</a>";   
             
                       }
                       elseif($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2))
                       {
                           $pagination.= "<a href='admin.php?page=dang_ky_lai_thu&limit=".$limit."&page-load=1'>1</a>";
                           $pagination.= "<a href='admin.php?page=dang_ky_lai_thu&limit=".$limit."&page-load=2'>2</a>";
                           $pagination.= "...";
                    ...
                    if($page < $counter - 1)
                        $pagination.= "<a href='admin.php?page=dang_ky_lai_thu&limit=".$limit."&page-load=".$next."'>Next &raquo;</a>";
                    else
